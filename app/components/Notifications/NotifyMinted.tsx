...
function NotifyMinted({ show, setShow }: NotifyMintedProps) {
  useEffect(() => {
    if (show) {
              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm font-medium text-zinc-100">xNFT Successfully minted!</p>
                    <p className="mt-1 text-sm text-zinc-300">Redirecting, one sec... </p>
                  </div>
...
export default memo(NotifyMinted);
